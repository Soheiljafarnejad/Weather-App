  ...
  return (
    ...
    >
      ...
      <div
        className={`${
          toggle ? "block" : "hidden"
        } w-full md:bg-secondary-color text-color flex flex-col mt-3 items-start justify-start rounded-md absolute md:static bottom-16 md:bottom-14`}
      >
        <button
          onClick={switchTheme}
          data-theme="light"
          className="flex items-center md:justify-start justify-center w-full py-1 md:py-2 px-4 md:hover:bg-gray-300 md:dark:hover:bg-slate-500 md:border-t border-t-gray-300 dark:border-t-gray-600"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-10 w-10 md:w-6 md:h-6 bg-secondary-color md:bg-opacity-0 md:dark:bg-opacity-0 p-2 md:p-0 rounded-full"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
